...
interface BottomSheetProps {
  ...
  initialName?: string; // 초기 이름
}

const BottomSheet: React.FC<BottomSheetProps> = ({ onClose, onSubmit, initialName }) => {
  const [name, setName] = useState<string>(''); // 변경된 이름 저장
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {  
    ...
    const res = await fetch(`${API}/auth/users/me/${userid}`, { // 서버 URL)
