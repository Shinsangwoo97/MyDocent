const WithdrawClose: React.FC<{ onClose: () => void, onCancel: () => void }> = ({ onClose, onCancel }) => {
  return (
    <>
        ...
        <div className="rounded-[20px] bg-[#151718] p-[20px]">
          <div className="text-center mb-5">
            ...
            <p className="text-[15px] text-[#787B83] mt-2">
              마이 도슨트를 이용해 주셔서 감사했습니다
            </p>
            <p className="text-[15px] text-[#787B83]">
              아쉽지만 다시 만날 수 있길 바랄게요
            </p>
          </div>
